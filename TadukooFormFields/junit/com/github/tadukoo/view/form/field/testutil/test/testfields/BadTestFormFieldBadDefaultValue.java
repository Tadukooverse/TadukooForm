 ...
 * @version Alpha v.0.4
 */
public class BadTestFormFieldBadDefaultValue extends TestFormField{
	...
	public static class BadTestFormFieldBuilder extends TestFormFieldBuilder{
		...
		/** {@inheritDoc} */
		@Override
		public BadTestFormFieldBadDefaultValue build(){
			return new BadTestFormFieldBadDefaultValue(key,
	 ...
	 */
	protected BadTestFormFieldBadDefaultValue(
			String key,
