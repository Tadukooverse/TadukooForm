 ...
 * @version Alpha v.0.4
 */
public class BadTestFormFieldBadLogFontResourceLoaderWarnings extends TestFormField{
	...
	public static class BadTestFormFieldBuilder extends TestFormFieldBuilder{
		...
		/** {@inheritDoc} */
		@Override
		public BadTestFormFieldBadLogFontResourceLoaderWarnings build(){
			return new BadTestFormFieldBadLogFontResourceLoaderWarnings(key, defaultValue,
	 ...
	 */
	protected BadTestFormFieldBadLogFontResourceLoaderWarnings(
			...
			EasyLogger logger, GraphicsEnvironment graphEnv,
		...
		super(key, defaultValue,
				...
				labelShape, labelBorder,
				rowPos, colPos, rowSpan, colSpan,
				DEFAULT_LOG_FONT_RESOURCE_LOADER_WARNINGS, logger, graphEnv,
				fontFolder, fontResourceLoader);
	}
