 ...
 * @version Alpha v.0.4
 */
public class BadTestFormFieldBadLabelBorder extends TestFormField{
	...
	public static class BadTestFormFieldBuilder extends TestFormFieldBuilder{
		...
		/** {@inheritDoc} */
		@Override
		public BadTestFormFieldBadLabelBorder build(){
			return new BadTestFormFieldBadLabelBorder(key, defaultValue,
	 ...
	 */
	protected BadTestFormFieldBadLabelBorder(
