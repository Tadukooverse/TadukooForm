 ...
 * @version Alpha v.0.4
 */
public class BadTestFormFieldBadFontSize extends TestFormField{
	...
	public static class BadTestFormFieldBuilder extends TestFormFieldBuilder{
		...
		/** {@inheritDoc} */
		@Override
		public BadTestFormFieldBadFontSize build(){
			return new BadTestFormFieldBadFontSize(key, defaultValue,
					labelType, labelForegroundPaint, labelBackgroundPaint,
					labelFontFamily, labelFontStyle,
	...
	protected BadTestFormFieldBadFontSize(
		...
		super(key, defaultValue,
				labelType, labelForegroundPaint, labelBackgroundPaint,
				labelFontFamily, labelFontStyle, WRONG_LABEL_FONT_SIZE,
				labelShape, labelBorder,
				rowPos, colPos, rowSpan, colSpan,
				logFontResourceLoaderWarnings, logger, graphEnv,
				fontFolder, fontResourceLoader);
