 ...
 * @version Alpha v.0.4
 */
public class BadTestFormFieldBadColSpan extends TestFormField{
	 ...
	 */
	protected BadTestFormFieldBadColSpan(
			...
			int rowPos, int colPos, int rowSpan,
		...
		super(key, defaultValue,
				...
				labelFontFamily, labelFontStyle, labelFontSize,
				labelShape, labelBorder,
				rowPos, colPos, rowSpan, WRONG_COL_SPAN,
				logFontResourceLoaderWarnings, logger, graphEnv,
				fontFolder, fontResourceLoader);
	}
