 ...
 * @version Alpha v.0.4
 */
public class BadTestFormFieldBadLabelShape extends TestFormField{
	...
	public static class BadTestFormFieldBuilder extends TestFormFieldBuilder{
		...
		/** {@inheritDoc} */
		@Override
		public BadTestFormFieldBadLabelShape build(){
			return new BadTestFormFieldBadLabelShape(key, defaultValue,
	 ...
	 */
	protected BadTestFormFieldBadLabelShape(
