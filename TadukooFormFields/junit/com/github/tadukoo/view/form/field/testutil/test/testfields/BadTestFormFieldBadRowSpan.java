 ...
 * @version Alpha v.0.4
 */
public class BadTestFormFieldBadRowSpan extends TestFormField{
	 ...
	 */
	protected BadTestFormFieldBadRowSpan(
			...
			int rowPos, int colPos, int colSpan,
		...
		super(key, defaultValue,
				...
				labelFontFamily, labelFontStyle, labelFontSize,
				labelShape, labelBorder,
				rowPos, colPos, WRONG_ROW_SPAN, colSpan,
				logFontResourceLoaderWarnings, logger, graphEnv,
				fontFolder, fontResourceLoader);
	}
