...
/**
 * Represents a {@link FormField} for a password field
 *
...
public class PasswordFormField extends FormField<String>{
	...
	/**
	 * Builder to be used to create a {@link PasswordFormField}. It has the following parameters:
	 *
	 * <table>
	 *     <caption>PasswordFormField Parameters</caption>
	 *     <tr>
	 *         <th>Name</th>
	 *         <th>Description</th>
	 ...
	 * @version Alpha v.0.4
	 */
	public static class PasswordFormFieldBuilder extends FormFieldBuilder<String>{
		/** Whether the field can be edited or not */
		private boolean editable = true;
		/** Number of columns used to determine the width of the field */
		private int columns = -1;
		
		/** Can't create PasswordFormFieldBuilder outside PasswordFormField */
		private PasswordFormFieldBuilder(){
			super();
			defaultValue = "";
		}
		...
		/** {@inheritDoc} */
		@Override
		public PasswordFormFieldBuilder key(String key){
			super.key(key);
			return this;
		}
		...
		/** {@inheritDoc} */
		@Override
		public PasswordFormFieldBuilder defaultValue(String defaultValue){
		...
		/** {@inheritDoc} */
		@Override
		public PasswordFormFieldBuilder labelType(LabelType labelType){
		...
		/** {@inheritDoc} */
		@Override
		public PasswordFormFieldBuilder labelForegroundPaint(SizablePaint labelForegroundPaint){
		...
		/** {@inheritDoc} */
		@Override
		public PasswordFormFieldBuilder labelBackgroundPaint(SizablePaint labelBackgroundPaint){
		...
		/** {@inheritDoc} */
		@Override
		public PasswordFormFieldBuilder labelFont(FontFamily labelFontFamily, int labelFontStyle, int labelFontSize){
		...
		/** {@inheritDoc} */
		@Override
		public PasswordFormFieldBuilder labelShape(ShapeInfo labelShape){
		...
		/** {@inheritDoc} */
		@Override
		public PasswordFormFieldBuilder labelBorder(Border labelBorder){
		...
		/** {@inheritDoc} */
		@Override
		public PasswordFormFieldBuilder rowPos(int rowPos){
			super.rowPos(rowPos);
			return this;
		}
		...
		/** {@inheritDoc} */
		@Override
		public PasswordFormFieldBuilder colPos(int colPos){
			super.colPos(colPos);
			return this;
		}
		...
		/** {@inheritDoc} */
		@Override
		public PasswordFormFieldBuilder rowSpan(int rowSpan){
		...
		/** {@inheritDoc} */
		@Override
		public PasswordFormFieldBuilder colSpan(int colSpan){
		...
		/** {@inheritDoc} */
		@Override
		public PasswordFormFieldBuilder logFontResourceLoaderWarnings(boolean logFontResourceLoaderWarnings){
		...
		/** {@inheritDoc} */
		@Override
		public PasswordFormFieldBuilder logger(EasyLogger logger){
			super.logger(logger);
			return this;
		}
		...
		/** {@inheritDoc} */
		@Override
		public PasswordFormFieldBuilder graphEnv(GraphicsEnvironment graphEnv){
		...
		/** {@inheritDoc} */
		@Override
		public PasswordFormFieldBuilder fontFolder(String fontFolder){
		...
		/** {@inheritDoc} */
		@Override
		public PasswordFormFieldBuilder fontResourceLoader(FontResourceLoader fontResourceLoader){
		 ...
		 */
		public PasswordFormFieldBuilder editable(boolean editable){
		 ...
		 * @return this, to continue building
		 */
		public PasswordFormFieldBuilder columns(int columns){
		...
		/** {@inheritDoc} */
		@Override
		public PasswordFormField build(){
			return new PasswordFormField(key, defaultValue,
	...
	/**
	 * Creates a new PasswordFormField with the given parameters.
	 *
	...
	protected PasswordFormField(
		...
		super(FieldType.PASSWORD, key, defaultValue,
				labelType, labelForegroundPaint, labelBackgroundPaint,
				labelFontFamily, labelFontStyle, labelFontSize,
				labelShape, labelBorder,
				rowPos, colPos, rowSpan, colSpan,
	...
	/**
	 * @return A {@link PasswordFormFieldBuilder builder} to build a {@link PasswordFormField}
	 */
	public static PasswordFormFieldBuilder builder(){
		return new PasswordFormFieldBuilder();
	}
