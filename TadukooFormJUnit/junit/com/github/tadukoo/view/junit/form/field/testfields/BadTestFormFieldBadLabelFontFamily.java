 ...
 * @version Alpha v.0.4
 */
public class BadTestFormFieldBadLabelFontFamily extends TestFormField{
	...
	public static class BadTestFormFieldBuilder extends TestFormFieldBuilder{
		...
		/** {@inheritDoc} */
		@Override
		public BadTestFormFieldBadLabelFontFamily build(){
			return new BadTestFormFieldBadLabelFontFamily(key, defaultValue,
					labelType, labelForegroundPaint, labelBackgroundPaint,
					labelFontStyle, labelFontSize,
	...
	protected BadTestFormFieldBadLabelFontFamily(
		...
		super(key, defaultValue,
				labelType, labelForegroundPaint, labelBackgroundPaint,
				WRONG_LABEL_FONT_FAMILY, labelFontStyle, labelFontSize,
				labelShape, labelBorder,
				rowPos, colPos, rowSpan, colSpan,
				logFontResourceLoaderWarnings, logger, graphEnv,
				fontFolder, fontResourceLoader);
