 ...
 * @version Alpha v.0.4
 */
public class BadTestFormFieldBadCustomSetting extends TestFormField{
	...
	public static class BadTestFormFieldBuilder extends TestFormFieldBuilder{
		...
		/** {@inheritDoc} */
		@Override
		public BadTestFormFieldBadCustomSetting build(){
			return new BadTestFormFieldBadCustomSetting(key, defaultValue,
	 ...
	 */
	protected BadTestFormFieldBadCustomSetting(
		...
		super(key, defaultValue,
				...
				rowPos, colPos, rowSpan, colSpan,
				logFontResourceLoaderWarnings, logger, graphEnv,
				fontFolder, fontResourceLoader, WRONG_EDITABLE);
	}
