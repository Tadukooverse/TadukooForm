 ...
 * @version Alpha v.0.4
 */
public class BadTestFormFieldBadLabelType extends TestFormField{
	...
	public static class BadTestFormFieldBuilder extends TestFormFieldBuilder{
		...
		/** {@inheritDoc} */
		@Override
		public BadTestFormFieldBadLabelType build(){
			return new BadTestFormFieldBadLabelType(key, defaultValue,
					labelForegroundPaint, labelBackgroundPaint,
	 ...
	 */
	protected BadTestFormFieldBadLabelType(
			String key, String defaultValue,
			SizablePaint labelForegroundPaint, SizablePaint labelBackgroundPaint,
		...
		super(key, defaultValue,
				WRONG_LABEL_TYPE, labelForegroundPaint, labelBackgroundPaint,
				labelFontFamily, labelFontStyle, labelFontSize,
				labelShape, labelBorder,
				rowPos, colPos, rowSpan, colSpan,
				logFontResourceLoaderWarnings, logger, graphEnv,
