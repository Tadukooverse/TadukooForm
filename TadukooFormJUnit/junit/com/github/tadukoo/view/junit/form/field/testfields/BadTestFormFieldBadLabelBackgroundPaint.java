 ...
 * @version Alpha v.0.4
 */
public class BadTestFormFieldBadLabelBackgroundPaint extends TestFormField{
	...
	public static class BadTestFormFieldBuilder extends TestFormFieldBuilder{
		...
		/** {@inheritDoc} */
		@Override
		public BadTestFormFieldBadLabelBackgroundPaint build(){
			return new BadTestFormFieldBadLabelBackgroundPaint(key, defaultValue,
					labelType, labelForegroundPaint,
	 ...
	 */
	protected BadTestFormFieldBadLabelBackgroundPaint(
			String key, String defaultValue,
			LabelType labelType, SizablePaint labelForegroundPaint,
		...
		super(key, defaultValue,
				labelType, labelForegroundPaint, WRONG_LABEL_BACKGROUND_PAINT,
				labelFontFamily, labelFontStyle, labelFontSize,
				labelShape, labelBorder,
				rowPos, colPos, rowSpan, colSpan,
				logFontResourceLoaderWarnings, logger, graphEnv,
