 ...
 * @version Alpha v.0.4
 */
public class BadTestFormFieldBadFontResourceLoader extends TestFormField{
	...
	public static class BadTestFormFieldBuilder extends TestFormFieldBuilder{
		...
		/** {@inheritDoc} */
		@Override
		public BadTestFormFieldBadFontResourceLoader build(){
			return new BadTestFormFieldBadFontResourceLoader(key, defaultValue,
	 ...
	 *                   - can be ignored if you specify your own FontResourceLoader
	 */
	protected BadTestFormFieldBadFontResourceLoader(
		...
		super(key, defaultValue,
				...
				rowPos, colPos, rowSpan, colSpan,
				logFontResourceLoaderWarnings, logger, graphEnv,
				fontFolder, WRONG_FONT_RESOURCE_LOADER);
	}
