 ...
 * @version Alpha v.0.4
 */
public class BadTestFormFieldBadGraphEnv extends TestFormField{
	...
	public static class BadTestFormFieldBuilder extends TestFormFieldBuilder{
		...
		/** {@inheritDoc} */
		@Override
		public BadTestFormFieldBadGraphEnv build(){
			return new BadTestFormFieldBadGraphEnv(key, defaultValue,
					...
					logFontResourceLoaderWarnings, logger,
	 ...
	 */
	protected BadTestFormFieldBadGraphEnv(
			...
			boolean logFontResourceLoaderWarnings, EasyLogger logger,
		...
		super(key, defaultValue,
				...
				labelShape, labelBorder,
				rowPos, colPos, rowSpan, colSpan,
				logFontResourceLoaderWarnings, logger, DEFAULT_GRAPH_ENV,
				fontFolder, fontResourceLoader);
	}
