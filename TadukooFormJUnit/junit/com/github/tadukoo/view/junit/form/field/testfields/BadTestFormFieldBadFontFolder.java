 ...
 * @version Alpha v.0.4
 */
public class BadTestFormFieldBadFontFolder extends TestFormField{
	...
	public static class BadTestFormFieldBuilder extends TestFormFieldBuilder{
		...
		/** {@inheritDoc} */
		@Override
		public BadTestFormFieldBadFontFolder build(){
			return new BadTestFormFieldBadFontFolder(key, defaultValue,
	 ...
	 */
	protected BadTestFormFieldBadFontFolder(
		...
		super(key, defaultValue,
				...
				rowPos, colPos, rowSpan, colSpan,
				logFontResourceLoaderWarnings, logger, graphEnv,
				WRONG_FONT_FOLDER, fontResourceLoader);
	}
