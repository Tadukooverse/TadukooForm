 ...
 * @version Alpha v.0.4
 */
public class BadTestFormField extends TestFormField{
	 ...
	 * @version Alpha v.0.4
	 */
	public static class BadTestFormFieldBuilder extends TestFormField.TestFormFieldBuilder{
		...
		/** {@inheritDoc} */
		@Override
		public BadTestFormField build(){
			return new BadTestFormField();
		}
	}
	
	/**
	 * Creates a new BadTestFormField with the given parameters
	 */
	private BadTestFormField(){
		super(WRONG_KEY, WRONG_DEFAULT_VALUE,
				WRONG_LABEL_TYPE, WRONG_LABEL_FOREGROUND_PAINT, WRONG_LABEL_BACKGROUND_PAINT,
				WRONG_LABEL_FONT_FAMILY, WRONG_LABEL_FONT_STYLE, WRONG_LABEL_FONT_SIZE,
				WRONG_LABEL_SHAPE, WRONG_LABEL_BORDER,
				WRONG_ROW_POS, WRONG_COL_POS, WRONG_ROW_SPAN, WRONG_COL_SPAN,
				DEFAULT_LOG_FONT_RESOURCE_LOADER_WARNINGS, WRONG_LOGGER, DEFAULT_GRAPH_ENV,
				WRONG_FONT_FOLDER, WRONG_FONT_RESOURCE_LOADER, WRONG_EDITABLE);
	}
