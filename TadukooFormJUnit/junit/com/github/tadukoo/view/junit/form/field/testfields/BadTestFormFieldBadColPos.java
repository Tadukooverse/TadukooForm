 ...
 * @version Alpha v.0.4
 */
public class BadTestFormFieldBadColPos extends TestFormField{
	 ...
	 */
	protected BadTestFormFieldBadColPos(
			...
			int rowPos, int rowSpan, int colSpan,
		...
		super(key, defaultValue,
				...
				labelFontFamily, labelFontStyle, labelFontSize,
				labelShape, labelBorder,
				rowPos, WRONG_COL_POS, rowSpan, colSpan,
				logFontResourceLoaderWarnings, logger, graphEnv,
				fontFolder, fontResourceLoader);
	}
