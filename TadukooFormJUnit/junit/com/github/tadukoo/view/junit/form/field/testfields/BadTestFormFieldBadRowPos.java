 ...
 * @version Alpha v.0.4
 */
public class BadTestFormFieldBadRowPos extends TestFormField{
	 ...
	 */
	protected BadTestFormFieldBadRowPos(
			...
			int colPos, int rowSpan, int colSpan,
		...
		super(key, defaultValue,
				...
				labelFontFamily, labelFontStyle, labelFontSize,
				labelShape, labelBorder,
				WRONG_ROW_POS, colPos, rowSpan, colSpan,
				logFontResourceLoaderWarnings, logger, graphEnv,
				fontFolder, fontResourceLoader);
	}
