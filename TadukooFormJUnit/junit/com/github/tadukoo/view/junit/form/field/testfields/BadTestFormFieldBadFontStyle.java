 ...
 * @version Alpha v.0.4
 */
public class BadTestFormFieldBadFontStyle extends TestFormField{
	...
	public static class BadTestFormFieldBuilder extends TestFormField.TestFormFieldBuilder{
		...
		/** {@inheritDoc} */
		@Override
		public BadTestFormFieldBadFontStyle build(){
			return new BadTestFormFieldBadFontStyle(key, defaultValue,
	...
	protected BadTestFormFieldBadFontStyle(
		...
		super(key, defaultValue,
				labelType, labelForegroundPaint, labelBackgroundPaint,
				labelFontFamily, WRONG_LABEL_FONT_STYLE, labelFontSize,
				labelShape, labelBorder,
				rowPos, colPos, rowSpan, colSpan,
				logFontResourceLoaderWarnings, logger, graphEnv,
				fontFolder, fontResourceLoader);
