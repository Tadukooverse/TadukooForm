 ...
 */
public abstract class FormFieldTest<Type>{
	...
	public void testFieldType(){
		assertEquals(testVals.getFieldType(), defaultFormField.getType());
	}
	...
	public void testDefaultLabelType(){
		assertEquals(testVals.getDefaultLabelType(), defaultFormField.getLabelType());
	}
	...
	public void testSetLabelType() throws Throwable{
		...
		assertEquals(testVals.getTestLabelType(), field.getLabelType());
	}
